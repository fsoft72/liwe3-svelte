...
<div class={`${divClass} input-container checkbox ${size}`} style={`width:auto;`}>
	{#if label}
...
<style>
	...
	/* Checkmark size variants */
	input[type='checkbox'].xxs:checked::after {
		font-size: 0.6rem;
	}

	input[type='checkbox'].xs:checked::after {
		font-size: 0.7rem;
	}
	...
	input[type='checkbox'].xxl:checked::after {
		font-size: 2.1rem;
	}
