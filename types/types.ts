...
export type LayoutVars = 'font-size' | 'font-weight' | 'line-height' | 'border-radius' | 'border-width' | 'border-style' | 'button-padding-y' | 'button-padding-x' | 'form-padding-y' | 'form-padding-x';
